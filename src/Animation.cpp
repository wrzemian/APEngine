...
Shader *animationShader = new Shader("res/shaders/animationsShader.vert", "res/shaders/animationsShader.frag");
...
void Animation::renderAnimation(float time) {
    ...
    animationShader->setVec4("color", glm::vec4(1.0f, 0.0f, 0.0f, 1.0f));
