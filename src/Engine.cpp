...
int Engine::SCR_WIDTH = 800;   // Adjust default width as necessary
int Engine::SCR_HEIGHT = 600;  // Adjust default height as necessary

Parser Engine::parser("../../res/jsons");
float Engine::frameEnd = 0;
float Engine::frameStart = 0;
float Engine::deltaTime = 0;
int Engine::Weights = 0;
unsigned int Engine::displayCounter = 0;
unsigned int Engine::totalCounter = 0;

bool Engine::frustum = true;

bool  Engine::renderDynamic = false;
bool  Engine::renderStatic = false;
int   Engine::renderedStatic = -1;
int   Engine::renderedDynamic = -1;

std::vector<Hitbox*> Engine::staticHitboxes;
std::vector<Hitbox*> Engine::dynamicHitboxes;
std::vector<IGui*> Engine::allImgui;
std::vector<Object3D*> Engine::allObjects;
std::vector<MovingObject*> Engine::allMovingObjects;
std::vector<DirectionalLight*> Engine::allDirLights;
std::vector<PointLight*> Engine::allPointLights;
std::vector<SpotLight*> Engine::allSpotLights;
std::vector<Ant*> Engine::allAnts;
